...
The data folder houses all files that are necessary to run the code and the project-generated files as well. Before running the code, please make sure to download the folder data from the link provided at the end of this document (Additional files and folders). Additionally, data must be placed directly inside the group04_team04 directory. If the folder is renamed or placed elsewhere, the code will not function correctly. 
